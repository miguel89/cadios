...
a persistence unit "cadiosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "cadios\pom.xml":
...
artifact ("cadios.war") is already built. You can build
